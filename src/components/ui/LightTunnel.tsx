...
const ctxMap = new WeakMap<HTMLElement, CtxEntry>();
  ...
  useEffect(() => {
    ...
    const program = new Program(gl, {
      ...
      uniforms: {
        ...
        uOpacity: { value: 1.0 },
        uCableColor: { value: new Float32Array([0.043, 0.157, 0.094]) },
        uPulseColor: { value: new Float32Array([0.176, 0.314, 0.086]) },
        uTunnelColor: { value: new Float32Array([0.024, 0.078, 0.047]) },
