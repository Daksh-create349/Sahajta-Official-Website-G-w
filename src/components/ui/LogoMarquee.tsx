...
const TOOLS: ToolLogo[] = [
  {
    ...
    renderIcon: () => (
      <svg viewBox="0 0 24 24" className="w-12 h-12 sm:w-14 sm:h-14 fill-[#0B422A] transition-transform duration-200 group-hover/card:scale-110 group-hover/card:fill-[#2D6E54]">
  ...
  },
  {
    ...
    category: 'Backend & ML',
    renderIcon: () => (
      <svg viewBox="0 0 24 24" className="w-12 h-12 sm:w-14 sm:h-14 fill-[#2D6E54] transition-transform duration-200 group-hover/card:scale-110 group-hover/card:fill-[#4A8C6F]">
